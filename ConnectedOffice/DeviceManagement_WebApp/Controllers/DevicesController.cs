...
namespace DeviceManagement_WebApp.Controllers
{
    public class DevicesController : Controller
    {
        ...
        {
            ViewData["CategoryId"] = _devicesRepository.GetCategory();
            ViewData["ZoneId"] = _devicesRepository.GetZone();
            return View();
        }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            ViewData["CategoryId"] = _devicesRepository.UpdateCategory(id);
            ViewData["ZoneId"] = _devicesRepository.UpdateZone(id);
            return View(device);
        }
